...
- **阿里云 PolarDB** (2017)：Aurora 的直接对标，共享分布式存储 (Pangu)
...
7. **FoundationDB**: Baker et al., "FoundationDB: A Distributed unbundled Transactional Key Value Store", 2013
